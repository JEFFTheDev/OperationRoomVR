...
namespace Assets.ManusVR.Scripts
{
    ...
    */
    public class Manus
    {
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 ManusGetDongleIDs(manus_session_t session,  UInt32[] out_ids, UInt32 count);
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusSetVibration(manus_session_t session, device_type_t device_type, float power, UInt16 milliseconds);
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusSetVibration_id(manus_session_t session, UInt32 dongle_id, device_type_t device_type, float power, UInt16 milliseconds);
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern UInt32 ManusCreateProfile(manus_session_t session, String name);
        ...
        *
        *  \param profile The new profile data to set in the working copy.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool ManusIsConnected_id(manus_session_t session, UInt32 dongle_id, device_type_t device);
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetBatteryLevel(manus_session_t session, device_type_t device_type, out byte out_percentage);
        /*! Get the current battery level in percent.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetBatteryLevel_id(manus_session_t session, UInt32 dongle_id, device_type_t device_type, out byte out_percentage);

        /*! Get the current battery level in millivolt.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetBatteryVoltage(manus_session_t session, device_type_t device_type, out UInt16 out_millivolts);
        /*! Get the current battery level in millivolt.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetBatteryVoltage_id(manus_session_t session, UInt32 dongle_id, device_type_t device_type, out UInt16 out_millivolts);

        /*! Get the signal strength.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetSignalStrength(manus_session_t session, device_type_t device_type, out UInt16 out_rssi);
        /*! Get the signal strength.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetSignalStrength_id(manus_session_t session, UInt32 dongle_id, device_type_t device_type, out UInt16 out_rssi);
        ...
        *  \param out_hand The output struct, also contains the raw data from the device.
        *  \param timeout The time in milliseconds to block waiting on a new packet.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        ...
        *
        *  \param channel The channel to set the dongle to.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusSetChannel(manus_session_t session, UInt32 channel);
        /*! Sets the dongle channel
        *
        *  \param dongle_id The ID of the dongle that this call is meant for.
        *  \param channel The channel to set the dongle to.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusSetChannel_id(manus_session_t session, UInt32 dongle_id, UInt32 channel);
        ...
        *
        *  \param device_type The device type to query.
        *  \param out_hand The output struct.
        *  \param timeout The time in milliseconds to block waiting on a new packet.
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetHandRaw(manus_session_t session, device_type_t device_type, out manus_hand_raw_t out_hand);
        /*! Get the raw data from the glove, this does not include any of the skeletal model data. If you're also
        *   interested in the skeletal model you should call ManusGetHand() instead.
        *
        *  \see ManusGetHand
        ...
        */
        [DllImport("Manus", CallingConvention = CallingConvention.Cdecl)]
        public static extern manus_ret_t ManusGetHandRaw_id(manus_session_t session, device_type_t device_type, out manus_hand_raw_t out_hand);
